import styles from "./skeuo.module.css";
    ...
    return (
        <div className={styles.page}>
            ...
            <header className={styles.hero}>
                <h1 className={styles.title}>Skeuomorphism</h1>
                <p className={styles.description}>
                    Uma interface inspirada em objetos e materiais do mundo
                    real.
                </p>
            </header>
            ...
            <main className={styles.content}>
                <section className={styles.section}>
                    <h2 className={styles.sectionTitle}>Botões</h2>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.card}>
                        <h3 className={styles.cardTitle}>Card de Skeuomorphism</h3>
                        <p className={styles.cardText}>
                            Essa é uma demonstração de texto em Skeuomorphism
                        </p>
                    </div>
                </section>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.alert}>
                        <strong className={styles.alertTitle}>Atenção</strong>
