...
export default function DarkUI() {
    return (
        <div className={styles.page}>
            <Navbar />

            <header className={styles.hero}>
                <h1 className={styles.title}>Dark UI</h1>
                <p className={styles.description}>
                    Uma interface baseada em tons escuros, contraste e
            ...
            <main className={styles.content}>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.card}>
                        <h3 className={styles.cardTitle}>Card de Dark UI</h3>

                        <p className={styles.cardText}>
                            Essa é uma demonstração de texto em Dark UI.
                        </p>
                    </div>
                </section>
