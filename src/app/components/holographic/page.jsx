    ...
    return (
        <div className={styles.page}>
            ...
            <header className={styles.hero}>
                <h1 className={styles.title}>Holographic UI</h1>
                <p className={styles.description}>
                    Uma interface inspirada em hologramas, reflexos iridescentes
                    e superfícies prismáticas.
                </p>
            </header>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.card}>
                        ...
                        <p className={styles.cardText}>
                            Essa é uma demonstração de texto em Holographic UI.
                        </p>
                    </div>
                </section>
