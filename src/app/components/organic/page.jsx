...
export default function OrganicUI() {
    return (
        <div className={styles.page}>
            <Navbar />

            <header className={styles.hero}>
                <h1 className={styles.title}>Organic UI</h1>
                <p className={styles.description}>
                    Uma interface inspirada em formas naturais, suaves e
                    fluidas.
                </p>
            </header>
            ...
            <main className={styles.content}>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.card}>
                        <h3 className={styles.cardTitle}>Card de Organic</h3>

                        <p className={styles.cardText}>
                            Essa é uma demonstração de texto em Organic
                        </p>
                    </div>
                </section>
