    ...
    return (
        <div className={styles.page}>
            ...
            <header className={styles.hero}>
                <h1 className={styles.title}>Claymorphism</h1>
                <p className={styles.description}>
                    Uma interface com elementos macios, arredondados e com
                    aparência de argila.
                </p>
            </header>
            ...
            <main className={styles.content}>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.card}>
                        <h3 className={styles.cardTitle}>Card de Claymorphism</h3>
                        <p className={styles.cardText}>
                            Essa é uma demonstração de texto em Claymorphism
                        </p>
                    </div>
                </section>
